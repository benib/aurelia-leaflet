System.config({
  ...
  map: {
    ...
    "benib/aurelia-leaflet": "github:benib/aurelia-leaflet@1.0.0",
    "bluebird": "npm:bluebird@3.4.1",
    "text": "github:systemjs/plugin-text@0.0.8",
    "whatwg-fetch": "npm:whatwg-fetch@2.0.1",
    "github:benib/aurelia-leaflet@1.0.0": {
      "aurelia-event-aggregator": "npm:aurelia-event-aggregator@1.0.1",
  ...
  depCache: {
    ...
    "example-code/example-code.js": [
      "aurelia-framework",
      "aurelia-fetch-client"
    ],
    "examples/base-layer.js": [
      "aurelia-framework"
    ],
    "examples/controls.js": [
      "aurelia-framework"
    ],
    "examples/default.js": [
      "aurelia-framework"
    ],
    "examples/featureGroup.js": [
      "aurelia-framework"
    ],
    "examples/geojson.js": [
      "aurelia-framework",
    ...
    "examples/load-event.js": [
      "aurelia-framework",
      "aurelia-event-aggregator"
    ],
    "examples/marker-with-popup.js": [
      "aurelia-framework"
    ],
    "examples/marker.js": [
      "aurelia-framework"
  ...
  bundles: {
    "app-build.js": [
      ...
      "app.js",
      "example-code/example-code.html!github:systemjs/plugin-text@0.0.8.js",
      "example-code/example-code.js",
      "examples.html!github:systemjs/plugin-text@0.0.8.js",
      "examples.js",
      "examples/base-layer.js",
      "examples/controls.html!github:systemjs/plugin-text@0.0.8.js",
      "examples/controls.js",
      "examples/default.html!github:systemjs/plugin-text@0.0.8.js",
      "examples/default.js",
      "examples/events.html!github:systemjs/plugin-text@0.0.8.js",
      "examples/featureGroup.js",
      "examples/full.html!github:systemjs/plugin-text@0.0.8.js",
      "examples/geojson.js",
      "examples/load-event.js",
      "examples/marker-with-popup.js",
      "examples/marker.js",
      "examples/only-layers.html!github:systemjs/plugin-text@0.0.8.js",
      "main.js",
      "quickstart.html!github:systemjs/plugin-text@0.0.8.js",
      "quickstart.js"
    ],
    "aurelia.js": [
